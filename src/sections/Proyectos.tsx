        ...
        {content.proyectos.proyectos.map((item, i) => (
          <Card shadow="sm" key={i}
            ...
            <CardBody className="overflow-visible p-4">
              {item.imagenes.find(i => i.portada == true)?.src
                ? <Image
                    shadow="sm"
                    width="100%"
                    radius="sm"
                  ...
                  />
                : <div className="w-full h-[220px] rounded-lg bg-gray-800 flex flex-col items-center justify-center gap-3 text-gray-500">
